        ...
        <div class="container">
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <h3 class="panel-title">Carga de Localidades</h3>
                </div>
                <div class="panel-body ">
                    <form method="post"  action="../FileUploadLocalidad" enctype="multipart/form-data" name="form1">
                ...
                <div class="row">
                    ...
                    <div class="text-center">
                        <label class="control-label col-lg-2" for="exportar"><a href="Localidades_gnr.jsp">Exportar<label class="glyphicon glyphicon-export"></label></a></label>
                    </div>
                </div>
                <div class="panel-footer">
                            <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="datosProv">
                                ...
                                try {
                                    ...
                                    con.conectar();                                    
                                        rset = con.consulta("SELECT * FROM tb_locais");   
                                    while (rset.next()) {                                       
                            %>
                             <tr>
