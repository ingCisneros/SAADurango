        ...
        <div class="container">
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <h3 class="panel-title">SUBIR INVENTARIO</h3>
                </div>
                <div class="panel-body ">
                    <form method="post" class="jumbotron"  action="SubirInvenServlet" enctype="multipart/form-data" name="form1" onsubmit="subeInven()">
