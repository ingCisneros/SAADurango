                ...
                <div class="panel-body">
                    <form name="FormKardex" action="kardexClave.jsp" method="Post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                ...
                                %>
                                <a class="btn btn-success" a href="gnrKardexClave.jsp?Clave=<%=Clave%>&Lote=<%=request.getParameter("Lote")%>&Cadu=<%=request.getParameter("Cadu")%>">Reporte de Trazabilidad</a>
                                <%
                                        }
                                    } catch (Exception e) {
                    ...
                    <h4>Caducidad: 
                        ...
                        <%
                            try {
                                con.conectar();
                                ResultSet rset = con.consulta("select SUM(F_ExiLot) from tb_lote where F_ClaPro = '" + Clave + "' and F_ClaLot ='" + request.getParameter("Lote") + "' and F_FecCad = STR_TO_Date('" + request.getParameter("Cadu") + "', '%d/%m/%Y') and F_Origen = '" + request.getParameter("F_Origen") + "'  and F_ExiLot !=0");
                                while (rset.next()) {
                                    String Total = "0";
