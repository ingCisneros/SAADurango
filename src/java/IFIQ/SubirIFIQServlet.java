 ...
 */
public class SubirIFIQServlet extends HttpServlet {

    LeeExcelIFIQ lee = new LeeExcelIFIQ();
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (isMultiPart) {
            ...
            try {
                ...
                while (itr.hasNext()) {
                    ...
                    if (item.isFormField()) {
                        ...
                        if (SubirIFIQ.processFile(path, item)) {
                            //response.getWriter().println("file uploaded successfully");
                            if (lee.obtieneArchivo(path, item.getName())) {
                                out.println("<script>alert('Se cargó el IFIQ Correctamente')</script>");
                            }
            ...
            out.println("<script>window.location='subirIFIQ.jsp'</script>");
