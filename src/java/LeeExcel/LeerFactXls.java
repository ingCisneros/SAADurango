 ...
 * @author Sistemas
 */
public class LeerFactXls {

     private Vector vectorDataExcelXLSX = new Vector();
    ConectionDB con = new ConectionDB();

    public boolean obtieneArchivo(String path, String file) {
        String excelXLSXFileName = path + "/RelacionaFacturas/" + file;
    ...
    public void displayDataExcelXLSX(Vector vectorData) {
        ...
        try {
                con.conectar();
                try {
                    String qry2 = "delete from tb_cargafactura";
                    con.insertar(qry2);
                } catch (Exception e) {
        ...
        for (int i = 0; i < vectorData.size(); i++) {
            ...
            String qry = "insert into tb_cargafactura values (";
