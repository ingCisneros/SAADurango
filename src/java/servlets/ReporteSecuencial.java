                        ...
                        while(FolioAgr.next()){
                           ...
                           if (Dife.equals("sin")){
                            ...
                            DatosFact = con.consulta("Select tb_unidis.F_MunUniIS AS F_MunUniIS, tb_unidis.F_LocUniIS AS F_LocUniIS, tb_unidis.F_JurUniIS AS F_JurUniIS, "
                                    ...
                                    + "From tb_factura INNER JOIN tb_lote ON (tb_factura.F_Lote = tb_lote.F_FolLot) Inner Join tb_artiis ON(tb_factura.F_ClaPro = tb_artiis.F_ClaInt) "
                                    ...
                                    + "Where  F_ClaDoc IN (Select F_Fol FROM tb_facagr WHERE F_FolAgr ='"+F_FolAgr+"') AND F_CantSur > 0 "
